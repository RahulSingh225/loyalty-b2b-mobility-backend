...
import { userTypeEntity, users, onboardingTypes, approvalStatuses, languages, appConfigs, userTypeLevelMaster, counterSales, retailers, electricians, retailerTransactions, earningTypes, schemes, counterSalesTransactions, electricianTransactions, retailerTransactionLogs, counterSalesTransactionLogs, retailerLedger, electricianLedger, counterSalesLedger, electricianTransactionLogs, schemeTypes, qrTypes, qrCodes, campaigns, redemptions, redemptionChannels, redemptionStatuses, auditLogs, systemLogs, eventLogs, notifications, referrals, client, locationLevelMaster, locationEntity, locationEntityPincode, pincodeMaster, skuLevelMaster, skuEntity, skuVariant, skuPointConfig, creativesTypes, creatives, ticketTypes, tickets, ticketStatuses } from "./schema";
