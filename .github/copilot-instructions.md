...
If anything here is unclear or you want a different level of detail (examples of a controller+service patch, or a migration/run checklist), tell me what to expand and I'll iterate.
