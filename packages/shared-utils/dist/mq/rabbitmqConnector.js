...
class RabbitMQConnector extends baseMQConnector_1.BaseMQConnector {
    constructor() {
        super(...arguments);
    ...
    publish(topic, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.channel)
                yield this.init();
            yield this.channel.assertQueue(topic, { durable: true });
    ...
    subscribe(topic, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.channel)
                yield this.init();
            yield this.channel.assertQueue(topic, { durable: true });
            yield this.channel.consume(topic, (msg) => __awaiter(this, void 0, void 0, function* () {
                if (msg) {
                    try {
